...
public void OnPluginStart()
{
	...
	// Read header
	{
		...
		decl String:id3v2_header_size_buffer[4];
		...
		int id3v2_header_size = view_as<int>(id3v2_header_size_buffer[0]);
	...
	// Read extended header
	{
		...
		if (isExtHeader) {
			...
			PrintToServer("Entering Frame ID; string: %s", interpretAsFrameID);
			
			// TCON - content type.
			// Everything fine thus far.
		}
	}
